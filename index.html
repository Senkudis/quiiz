...
<head>
    ...
    <style>
        ...
        .content { font-size: 1.3em; line-height: 1.8; font-weight: 500; direction: rtl; }
...
<script>
    ...
    function update() {
        // نستخدم innerHTML للسماح بعرض المعادلات
        qEl.innerHTML = data[currentIndex].Front;
        aEl.innerHTML = data[currentIndex].Back;
        ...
        // إعادة معالجة المعادلات الرياضية في حال لم تظهر
        if (window.MathJax) {
